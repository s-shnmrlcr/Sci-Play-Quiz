...
let correct_logo = `<div class="correct_design_notif">CORRECT!!</div>`;
let wrong_logo = `<div class="wrong_design_notif">INCORRECT!!</div>`;
...
let user_numbers_of_questions = 50;
 ...
 * Note: Do not change anything here. unless you know how to refactor the code in init_exam.js */
 	// fixed at 43 questions
 			// fixed at 20 questions
let numbers_of_exam_questions = user_numbers_of_questions;
...
/* Track which screen to show: 'login' or 'signup' */
let authScreenType = 'login';
...
let bgColorForSelectedButton = "#c2d7ee";
let bgColorForSelectedAnswer = "#b8cce2";
...
let quiz_scoreboard_userName = []; // Store user's name for each quiz attempt
...
let exam_scoreboard_userName = []; // Store user's name for each exam attempt
...
let topics = [
	// General Information
	"General Information - Topics on Male and Female Reproductive System",
	"General Information - Topics on Natural Selection and Evolution",
	"General Information - Topics on Biodiversity",

	"General Information"
];

/* This is name that will display to show result letter */
let letter_name = "Justine Martinez,\n Ayesha Samulde,\n Leslie Napao,\n Giff Sermida";

/* This is Position that will display to show result letter */
let letter_position = "SciPlay Research Team";
...
let SELECT = {
	...
	INSTRUCTION_TOPIC_00: 	`The following questions are about the male and female reproductive systems. Read each question carefully and choose the best answer.`,
	INSTRUCTION_TOPIC_01: 	`The following questions are about the natural selectiion and evolution. Read each question carefully and choose the best answer.`,
	INSTRUCTION_TOPIC_02: 	`The following questions are about biodiversity. Read each question carefully and choose the best answer`,
	
	
	INSTRUCTION_EXAM_00: 	`The following questions are about major science Topics. Read each question carefully and choose the best answer`,
};